...
urlpatterns = [ #pylint: disable=invalid-name
    ...
    path('recomendacion_proyecto/', RecomendacionProyectoListView.as_view(),
         name='lista-recomendaciones-proyecto'),
    path('recomendacion_proyecto/nuevo/', RecomendacionProyectoCreateView.as_view(),
         name='nuevo-recomendaciones-proyecto'),
    re_path(r'^recomendacion_proyecto/(?P<pk>\d+)/$', RecomendacionProyectoDetailView.as_view(),
            name='recomendaciones-proyecto'),
    re_path(r'^recomendacion_proyecto/editar/(?P<pk>\d+)/$', RecomendacionProyectoUpdateView.as_view(),
            name='editar-recomendaciones-proyecto'),
    re_path(r'^recomendacion_proyecto/borrar/(?P<pk>\d+)/$', RecomendacionProyectoDeleteView.as_view(),
            name='borrar-recomendaciones-proyecto'),
    path('conclusiones_proyecto/', ConclusionesListView.as_view(),
         name='lista-conclusiones'),
    path('conclusiones_proyecto/nuevo/', ConclusionesCreateView.as_view(),
         name='nueva-conclusiones-proyecto'),
    re_path(r'^conclusiones_proyecto/(?P<pk>\d+)/$', ConclusionDetailView.as_view(),
            name='conclusiones-proyecto'),
    re_path(r'^conclusiones_proyecto/editar/(?P<pk>\d+)/$', ConclusionUpdateView.as_view(),
