...
urlpatterns = [ #pylint: disable=invalid-name
    ...
    re_path(r'^recomendacion_proyecto/editar/(?P<pk>\d+)/$',
            RecomendacionProyectoUpdateView.as_view(),
            name='editar-recomendaciones-proyecto'),
    re_path(r'^recomendacion_proyecto/borrar/(?P<pk>\d+)/$',
            RecomendacionProyectoDeleteView.as_view(),
